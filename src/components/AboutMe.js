    ...
    return ( 
        <div className="aboutMe">
            <div className="content">
                ...
                <p className="ft-bold">Hello! My name is Damanveer Bharaj. I received my Software Engineering (B.Eng) degree from York University in 2021, where I began my journey working on enterprise level systems.</p>
