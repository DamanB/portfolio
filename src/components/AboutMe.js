    ...
    return ( 
        <div className="aboutMe">
            <div className="content">
                ...
                <p className="ft-bold">Hello my name is Damanveer Bharaj. I received my Software Engineering (B.Eng.) degree from York University in 202 and look forward to working on new and exciting projects throughout my career.   </p>
